...
QT_MOC_LITERAL(1, 11, 17), // "receiveMatchIndex"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 17), // "receiveUpdatedStr"
QT_MOC_LITERAL(4, 48, 6) // "string"

    },
    "textEditor\0receiveMatchIndex\0\0"
    "receiveUpdatedStr\0string"
};
...
void textEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->receiveMatchIndex((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->receiveUpdatedStr((*reinterpret_cast< string(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
